...
import { Store } from '@/components/store-sales'; // Import the Store class from store-sales module
...
export default function StoreForm({ onStoreAdded }) {
  ...
  const addStore = (event) => {
    ...
    const newStore = new Store(storeLocation, minCustomers, maxCustomers, avgCookieSales, [], 0);
    newStore.storeCalculator(); // Calculate the store sales
